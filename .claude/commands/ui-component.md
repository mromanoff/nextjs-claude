...
- [name]: Component name from $ARGUMENTS, conveted to PascalCase
- [summary]: Component summary from $ARGUMENTS


## Task

Make a single UI component according to the [name] and [summary] provided, following these guidelines:

- Create the component file in `src/components/ui/[name]/[name].tsx`
- Use a functional component with the name [name]
- Reference theh [summary] when making the component
